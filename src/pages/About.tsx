        ...
        <div className="container mx-auto max-w-5xl">
          <header className="text-center mb-16">
            ...
            <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
              "رحلة عبر قصص الأنبياء" هو موقع تفاعلي يهدف إلى تقديم قصص الأنبياء
              بأسلوب حديث يجمع بين المعرفة والمتعة. نسعى إلى تحويل التجربة من
              مجرد قراءة تقليدية إلى رحلة بصرية وتفاعلية تساعد المستخدم على فهم
              الأحداث واستيعاب الدروس بشكل أعمق.
            </p>
          </header>
          <section className="rounded-3xl border border-border bg-card p-8 md:p-12 mb-10 shadow-sm relative">
            ...
            <p className="text-base md:text-lg text-foreground">
              انطلقت فكرة المشروع من الحاجة إلى تقديم المحتوى الديني بشكل يناسب
              العصر الرقمي. بدلًا من عرض القصص كنصوص طويلة فقط، نوفر تجربة
              متكاملة تشمل:
            </p>
          ...
          <section className="mb-10">
            ...
            <span className="grid md:grid-cols-3 gap-5 pt-5 text-center">
              <Box
                icon="./src/assets/team/Mohamed Hasabo.jpeg"
                HeadLine="محمد أحمد حسبو"
                text="مطور Front-End"
                position="mx-auto"
                img={true}
              />
              <Box
                icon="./src/assets/team/Mostafa Sobhy.jpg"
                HeadLine="مصطفى صبحي فتحي"
                text="مطور Front-End"
                position="mx-auto"
                img={true}
              />
              <Box
                icon="./src/assets/team/Mohamed Raafat.jpg"
                HeadLine="محمد أحمد رأفت"
                text="مطور Front-End"
                position="mx-auto"
                img={true}
              />
              <Box
                icon="./src/assets/team/Kareem Sayed.jpeg"
                HeadLine="كريم سيد محمد"
                text="مطور Front-End"
                position="mx-auto"
                img={true}
              />
              <Box
                icon="./src/assets/team/Ahmed Ala'a.jpg"
                HeadLine="أحمد علاء عبد الوهاب"
                text="مطور Front-End"
                position="mx-auto"
                img={true}
              />
          ...
          <section className="rounded-3xl border border-border bg-card p-8 md:p-12 text-center mb-10 shadow-sm relative">
            ...
            <p className="text-muted-foreground md:text-lg mb-6">
              استكشف قصص الأنبياء واختبر معلوماتك الآن
            </p>
