...
export const prophets: Prophet[] = [
  {
    ...
    shortDesc: { ar: "أبو البشر وأول الأنبياء", en: "Father of humanity and the first prophet" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "نبي الحكمة والعلم", en: "Prophet of wisdom and knowledge" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "نبي الطوفان وأول أولي العزم", en: "Prophet of the flood and the first of the steadfast" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "أبو الأنبياء وخليل الرحمن", en: "Father of the prophets and friend of the Most Merciful" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "ذبيح الله وابن إبراهيم", en: "Sacrifice of God and son of Abraham" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "صاحب الرؤيا وعزيز مصر", en: "Owner of the dream and noble in Egypt" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "نبي الصبر والالتزام", en: "Prophet of patience and commitment" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "كليم الله ومُحاور فرعون", en: "Messenger of God and opponent of Pharaoh" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "أخ موسى ومساعده", en: "Brother of Moses and his assistant" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "نبي من بني إسرائيل", en: "Prophet from the children of Israel" },
    longDesc: {
  ...
  },
  {
    ...
    shortDesc: { ar: "نبي الدعاء والعبادة", en: "Prophet of prayer and worship" },
    longDesc: {
      ar: "دعا الله أن يرزقه ولدًا فاستجاب له ورزقه يحيى.",
      en: "He called upon Allah to grant him a son, and Allah responded to his prayer by giving him John."
    },
    order: 22,
    ululAzm: false,
  },
  ...
  },
  {
    ...
    shortDesc: { ar: "خاتم الأنبياء والمرسلين", en: "Seal of the Prophets and Messengers" },
    longDesc: {
