...
export const nuhStory: ProphetStory = {
  ...
  title: {
    ...
    en: "The Prophet of the Flood and the First of Strong Messengers",
  },

  hero: {
    ar: "دعا قومه 950 سنة بصبر حتى نجاه الله بالسفينة",
    en: "He preached for 950 years until Allah saved him with the Ark",
  },
  ...
  location: {
    ...
    en: "His people’s land then the Ark",
  },
  ...
  chapters: [
    {
      title: { ar: "بعثة نوح", en: "The Mission of Noah" },
      sections: [
        {
          text: {
            ar: "بدأ الشرك في قوم نوح حين عظّموا الصالحين وصنعوا لهم تماثيل",
            en: "Shirk began when people glorified the righteous and made statues",
          },
        },
        {
          text: {
            ar: "مع مرور الزمن عُبدت هذه التماثيل من دون الله",
            en: "Over time these statues were worshipped",
          },
        },
        {
          text: {
            ar: "فأرسل الله نوحًا ليعيد الناس إلى التوحيد",
    ...
    {
      title: { ar: "دعوة طويلة", en: "A Long Call" },
      sections: [
        {
          text: {
            ar: "دعا نوح قومه ليلًا ونهارًا بلا توقف",
            en: "Noah called his people day and night",
          },
        },
        {
          text: {
            ar: "دعاهم سرًا حفاظًا على مشاعرهم",
            en: "He called them secretly to be gentle",
          },
        },
        {
          text: {
            ar: "ودعاهم جهرًا ليصل إلى الجميع",
            en: "And publicly to reach everyone",
          },
        },
        {
          text: {
            ar: "وعدهم بالمغفرة والرزق إن آمنوا",
            en: "He promised forgiveness and provision",
          },
          ayah: {
    ...
    {
      title: { ar: "رد قومه", en: "Response of His People" },
      sections: [
        {
          text: {
            ar: "رفض قومه دعوته واستكبروا",
            en: "His people rejected him with arrogance",
          },
          ayah: {
        ...
        {
          text: {
            ar: "كانوا يضعون أصابعهم في آذانهم حتى لا يسمعوا",
            en: "They put fingers in their ears",
          },
        },
        {
          text: {
            ar: "غطوا أنفسهم بثيابهم رفضًا للحق",
            en: "They covered themselves to avoid truth",
          },
          ayah: {
        ...
        {
          text: {
            ar: "أصروا على عبادة أصنامهم",
            en: "They insisted on idol worship",
          },
        },
      ],
    },
    {
      title: { ar: "الدعاء على القوم", en: "The Supplication" },
      sections: [
        {
          text: {
            ar: "بعد قرون من الدعوة دون استجابة دعا نوح ربه",
            en: "After centuries with no response, Noah prayed",
          },
        },
        {
          text: {
            ar: "طلب نصرة المؤمنين وهلاك الظالمين",
            en: "He asked for the victory of believers",
          },
          ayah: {
    ...
    {
      title: { ar: "بناء السفينة", en: "Building the Ark" },
      sections: [
        {
          text: {
            ar: "أمر الله نوحًا أن يبني السفينة",
        ...
        {
          text: {
            ar: "صنعها من ألواح الخشب وثبتها بالمسامير",
            en: "He built it with wooden planks and nails",
          },
        },
        {
          text: {
            ar: "كان قومه يسخرون منه لأنه يبنيها في الصحراء",
            en: "His people mocked him for building it on land",
          },
          ayah: {
    ...
    {
      title: { ar: "بدء الطوفان", en: "The Flood Begins" },
      sections: [
        {
          text: {
            ar: "نزل المطر بغزارة شديدة",
            en: "Heavy rain poured from the sky",
          },
          ayah: {
        ...
        {
          text: {
            ar: "وجاء أمر الله فتفجرت الأرض بالماء",
            en: "Allah’s command came and water burst from earth",
          },
          ayah: {
        ...
        {
          text: {
            ar: "وارتفع الماء حتى غطى كل شيء",
            en: "Water rose and covered everything",
          },
        },
      ],
    },
    {
      ...
      sections: [
        {
          text: {
            ar: "ركب نوح السفينة مع المؤمنين",
            en: "Noah boarded the Ark with believers",
          },
        },
        {
          text: {
            ar: "حمل من كل زوجين اثنين من المخلوقات",
            en: "He carried pairs of creatures",
          },
          ayah: {
        ...
        {
          text: {
            ar: "سارت السفينة بأمر الله وسط الأمواج",
            en: "The Ark sailed through huge waves",
          },
          ayah: {
    ...
    {
      title: { ar: "ابن نوح", en: "Noah’s Son" },
      sections: [
        {
          text: {
            ar: "دعا نوح ابنه ليركب معهم وينجو",
            en: "Noah called his son to join",
          },
          ayah: {
        ...
        {
          text: {
            ar: "رفض وقال أنه سيحتمي بالجبل",
            en: "He refused and trusted a mountain",
          },
        },
        {
          text: {
            ar: "فغرق مع الكافرين",
            en: "He drowned with disbelievers",
          },
          ayah: {
    ...
    {
      title: { ar: "نهاية الطوفان", en: "End of the Flood" },
      sections: [
        {
          text: {
            ar: "أمر الله الأرض أن تبتلع ماءها",
            en: "Allah commanded earth to swallow water",
          },
        },
        {
          text: {
            ar: "وتوقفت السماء عن المطر",
            en: "The sky stopped raining",
          },
        },
        {
          text: {
            ar: "استقرت السفينة على جبل الجودي",
            en: "The Ark rested on a mountain",
          },
          ayah: {
    ...
    {
      title: { ar: "بعد الطوفان", en: "After the Flood" },
      sections: [
        {
          text: {
            ar: "نادى نوح ربه وقال له ان ابنه كان من أهله وان وعده هو الحق",
            en: "Noah called his Lord and said to Him, 'My son is one of My followers, and My promise is true.'",
          },
          ayah: {
        ...
        {
          text: {
            ar: "قال له الله يا نوح إن ابنك الذي هلك ليس من أهلك الذين وعدتك أن أنجيهم؛ وذلك بسبب كفره، وعمله عملا غير صالح، وإني أنهاك أن تسألني أمرًا لا علم لك به، إني أعظك لئلا تكون من الجاهلين في مسألتك إياي عن ذلك.",
            en: "God said to him, “O Noah, your son who perished is not one of your family whom I promised to save, because of his disbelief and his unrighteous deeds. I forbid you to ask me about something you have no knowledge of. I am advising you so that you will not be among the ignorant in asking me about that.",
          },
          ayah: {
        ...
        {
          text: {
            ar: "قال نوح ربه إني أعوذ بك أن أسألك ما ليس لي به علم وأنت علام الغيوب",
            en: "Noah said to his Lord, 'I seek refuge in You from asking You for that of which I have no knowledge. And unless You forgive me and have mercy upon me, I will be among the losers.'",
          },
          ayah: {
